...
import com.zcdyy.personalparameter.utils.CalculateUtil;
import com.zcdyy.personalparameter.utils.DensityUtil;
...
public class LineChart extends View {
     ...
     * 背景的颜色
     */
    private static final int BG_COLOR = Color.parseColor("#23cdde");
    /**
     * 视图的宽和高
     */
    ...
    private void drawCircles(Canvas canvas) {
        for (int i = 0; i < mData.size(); i++) {
            ...
            String text = String.valueOf(mData.get(i).getyValue());
            //只有在可见的范围内才绘制
            if(linePoints.get(i)>=xStartIndex&&linePoints.get(i)<(mTotalWidth-leftMargin*2)){
                ...
                canvas.drawText(text, linePoints.get(i), paintBottom - mData.get(i).getyValue() * maxHeight / maxDivisionValue, textPaint);
            }
        }
    }
    /**
