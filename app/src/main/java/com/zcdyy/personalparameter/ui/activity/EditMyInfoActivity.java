...
import com.zcdyy.personalparameter.bean.Pickers;
...
import com.zcdyy.personalparameter.views.PickerScrollView;
...
public class EditMyInfoActivity extends BaseActivity implements ActionSheet.OnSheetItemClickListener, View.OnClickListener, PickerScrollView.onSelectListener {
    ...
    private TextView sex, age, height, weight, phone;
    private RelativeLayout rl_head, rl_sex, rl_age, rl_height, rl_weight, rl_save;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case Constants.ResultCode.UPLOAD_SUCCESS:
                    dialog.dismiss();
                    ImageLoaderUtils.initImage(EditMyInfoActivity.this, loginuser.getHead().getFileUrl(), head, R.drawable.chat_xe_icon2_03);
                    ToastUtils.shortToast(EditMyInfoActivity.this, "图片上传完成");
                    break;
                case Constants.ResultCode.FAILED:
                    dialog.dismiss();
...
//        exit = findViewsById(R.id.activity_setting_btn_exit);
    }
