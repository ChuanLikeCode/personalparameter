...
public class DataUtils {
    ...
    public List<Praise> getPraiseList(){
        ...
        for (int i = 0;i<praiseInfoList.size();i++){
            ...
            praise.setHead(praiseUserInfo.get(i).getHead());
            praise.setName(praiseUserInfo.get(i).getName());
    ...
    public List<Comment> getCommetList(){
        ...
        for (int i = 0;i<commentInfoList.size();i++){
            ...
            comment.setName(commentUserInfo.get(i).getName());
            comment.setHead(commentUserInfo.get(i).getHead());
            ...
            if (comment.isReply()){
                ...
                comment.setReplyName(replyUserInfo.get(replyCount).getName());
                replyCount++;
            }
